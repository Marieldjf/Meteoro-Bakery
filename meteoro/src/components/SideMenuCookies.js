...
<div className="h-screen flex bg-white">
        ...
        <main className="flex-1 pt-2">
			...
			<div class="pl-6 pt-0 pb-6 h-16 rounded-md">
				...
				<div class="flex items-start justify-start pt-12 pl-6">
					<text  className="text-4xl text-gunmetal" id="tituloItem">Cookies
					</text>
            	</div>
            </div>
	...
	<div className="flex-row md:flex pt-2">
		...
		<img className="md:w-52 w-36 h-52 ml-10 -mt-52 md:h-64 md:mb-1 -mb-2 md:-mt-64 md:flex md:center md:ml-4" src={whitecookie}/>
			<h1 className="md:text-xl text-lg text-left ml-6 text-gunmetal cursor-default" id="tituloItem">White Chips Cookie</h1>
			<h2 className="md:text-lg text-sm text-left ml-6 text-naranja cursor-default" id="precioArticulo">RD$50.00 c/u</h2>
			<p className="md:mt-4 mt-2 text-sm md:text-lg text-center cursor-default pb-4" id="textodesc">Galleta crocante de vainilla con chispas de chocolate blanco.</p>
		...
		<img className="md:w-52 w-36 h-52 ml-10 -mt-52 md:h-64 md:-mb-2 -mb-2 md:-mt-64 md:flex md:center md:ml-8" src={cookiemixed}/>
			<h1 className="md:text-2xl text-lg text-left ml-6 text-gunmetal cursor-default" id="tituloItem">Chip Mix Cookie</h1>
			<h2 className="md:text-lg text-sm text-left ml-6 text-naranja cursor-default" id="precioArticulo">RD$350.00</h2>
			<p className="md:mt-4 mt-2 text-sm md:text-lg md:pb-1 cursor-default" id="textodesc">Galleta crocante de vainilla con mezcla de chispas de chocolate blanco y negro.</p>
...
export default SideMenuCookies;
