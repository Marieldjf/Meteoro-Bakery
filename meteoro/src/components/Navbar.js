...
const Navbar = () => {
    return (
        <div className="flex-1 md:h-20 md:flex md:items-center items-center flex md:justify-between bg-naranja">
            ...
            <button type="submit" class="md:absolute md:right-0 md:top-0 md:mt-1 md:mr-16 absolute mr-16 mt-1 left-42">
            ...
            {/* iconos */}
            <svg className="md:w-6 md:h-6 w-6 h-6 mr-2 cursor-pointer" fill="none" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
            <Link to="/checkout" ><svg className="md:w-6 md:h-6 md:ml-8 w-6 h-6 mr-1" fill="none" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg></Link>
